...
def normalize_features(raw) -> ndarray[Any, dtype[_SCT]]:
    """
...
def get_quantum_signature(data_row) -> ndarray:
    """
...
def compute_kernel(data_matrix):
    ...
    qkernel = qiskit_machine_learning.kernels.FidelityQuantumKernel(feature_map=build_feature_map())
...
def signature_from_dict(d) -> ndarray[Any, dtype[Any]]:
